...
1.10: 2026-04-17::
   Port fix for Mac OS compiler.

1.9: 2026-04-13::
   Parse hardening by ChatGPT 5.3
   Fix cases wheree ints could have been misparsed as bools and vice-versa.

1.8: 2024-10-11::
   CC 10 type cleanliness tweaks.
