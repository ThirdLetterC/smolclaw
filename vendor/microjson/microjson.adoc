...
Note: under some circumstances, this library will correctly parse
invalid JSON. In particular. it doesn't care, and dooesn't even know,
if a JSON object is correctly terminated. This is not a bug.
